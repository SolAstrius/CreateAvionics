...
public class GyroscopicPropellerBearingPeripheral extends PropellerBearingPeripheral<GyroscopicPropellerBearingBlockEntity> {
     ...
     * <p>The tilt animation itself runs on the server thread for `time`
     * seconds — this method only blocks for the dispatch tick, not the
     * duration.
     *
     ...
     * <p>As with {@link #setTilt}, the animation duration runs on the
     * server thread; this method only blocks for the dispatch tick.
     *
