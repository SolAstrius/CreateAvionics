 ...
 * its protected {@code movedContraption} field, and the computer behaviour we
 * inject into the BE's behaviours list.
 */
public interface MechanicalBearingExt {

    ScrollOptionBehaviour<RotationMode> createAvionics$movementMode();

    AbstractContraptionEntity createAvionics$movedContraption();
